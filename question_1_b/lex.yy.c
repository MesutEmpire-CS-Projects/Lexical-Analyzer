...
static const flex_int16_t yy_def[17] =
    {   0,
       12,    1,   12,   13,   14,   15,   12,   13,   14,   16,
       12,    0,   12,   12,   12,   12
    } ;

static const flex_int16_t yy_nxt[17] =
    {   0,
        4,    5,    6,    7,    7,   11,   10,    9,    8,   12,
        3,   12,   12,   12,   12,   12
    } ;
...
char *yytext;
#line 1 "question_1_b.l"
#line 2 "question_1_b.l"
#include <stdio.h>
...
case 1:
YY_RULE_SETUP
#line 8 "question_1_b.l"
{fprintf(output_fptr,"ABC");}
	YY_BREAK
case 2:
YY_RULE_SETUP
#line 9 "question_1_b.l"
{fprintf(output_fptr,"%s",yytext);}
	YY_BREAK
case 3:
/* rule 3 can match eol */
YY_RULE_SETUP
#line 10 "question_1_b.l"
{fprintf(output_fptr,"%s",yytext);}
	YY_BREAK
case 4:
YY_RULE_SETUP
#line 12 "question_1_b.l"
ECHO;
	YY_BREAK
#line 748 "lex.yy.c"
